...
const RejectionOrderSchema = new mongoose.Schema(
    {
        ...
        orderStatus: {
            type: String,
            enum: [
                "Initiated", "Pickup_Schedule", "PickedUp", 
                "Received", "Mismatch_Correction", "Validated", 
                "Approved_Credited", "Cancelled"
            ],
            default: "Initiated",
        },
        ...
        activities: [
            {
                status: {
                    type: String,
                    enum: [
                        "Initiated", "Cancelled", "Confirmed",
                        "Pickup_Schedule", "PickedUp", "Received",
                        "Mismatch_Correction", "Validated", "Approved_Credited"
                    ],
                    required: true
                },
