...
const updateProductValidation = Joi.object({
  brand: Joi.string()
    .optional()
    .messages({ "string.base": "Brand ID must be a string." }),
  category: Joi.string()
    .optional()
    .messages({ "string.base": "Category ID must be a string." }),
  series: Joi.string()
    .optional()
    .messages({ "string.base": "Series ID must be a string." }),
  hsnCode: Joi.string()
    .optional()
    .messages({ "string.base": "HSN Code must be a string." }),
  productName: Joi.string()
    .optional()
    .messages({ "string.base": "Product name must be a string." }),
  productUrl: Joi.string().optional().uri().messages({
    "string.base": "Product URL must be a string.",
    "string.uri": "Product URL must be a valid URL.",
  }),
  modelNo: Joi.string()
    .optional()
    .messages({ "string.base": "Model number must be a string." }),
  watt: Joi.string()
    .optional()
    .messages({ "string.base": "Watt must be a string." }),
  color: Joi.string()
    .optional()
    .messages({ "string.base": "Color must be a string." }),
  bodyColor: Joi.string()
    .optional()
    .messages({ "string.base": "Body color must be a string." }),
  price: Joi.string()
    .optional()
    .messages({ "string.base": "Price must be a string." }),
  stock: Joi.string()
    .optional()
    .messages({ "string.base": "Stock must be a string." }),
  featureProduct: Joi.string()
    .optional()
    .messages({ "string.base": "Feature product must be a string." }),
  newArrivals: Joi.string()
    .optional()
    .messages({ "string.base": "New arrivals must be a string." }),
  productThumbImage: Joi.string().optional().uri().messages({
    "string.base": "Product thumbnail image must be a string.",
    "string.uri": "Product thumbnail image must be a valid URL.",
  }),
  structure: Joi.string()
    .optional()
    .messages({ "string.base": "Structure must be a string." }),
  boxQuantity: Joi.string()
    .optional()
    .messages({ "string.base": "Box quantity must be a string." }),
