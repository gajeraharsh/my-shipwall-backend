...
const updateRolePermissionSchema = Joi.object({
    ...
    permissionType: Joi.string().valid("view", "add", "edit", "delete").required().messages({
...
export { createRoleValidation, updateRoleValidation, deleteRoleValidation, getRoleValidation, updateRolePermissionSchema };
