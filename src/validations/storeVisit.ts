...
export const createStoreVisitValidation = Joi.object({
...
export const getStoreVisitValidation = Joi.object({
...
export const updateStoreVisitValidation = Joi.object({
...
export const deleteStoreVisitValidation = Joi.object({
  id: Joi.string().required().messages({
    "any.required": "Store Visit ID is required",
    "string.empty": "Store Visit ID cannot be empty",
  }),
