...
const calculateTotals = async (cart) => {
  ...
  cart.products.forEach((item) => {
    ...
    if (product) {
      ...
      const pricePerItem = Math.round(product.price * boxQtyProduct);
...
const addToReturnCartService = async (
  userId,
  orderId,
  productId,
  returnQty
...
const removeFromCartService = async (userId, ordreId, productId) => {
...
const getCartService = async (userId, orderId) => {
